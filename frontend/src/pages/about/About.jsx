    ...
    <div className="about-container">
      <section className="about-hero-section">
        ...
        <div className="about-hero-content">
          <h1>About <strong style={{color:'red'}}>BlogVault</strong></h1>
      ...
      <section className="section">
        <div className="section-content">
          <div className="text">
            <h2>Our Mission</h2>
            <p>
              At BlogVault, we are dedicated to enhancing your online journey by
        ...
        <div className="section-content">
          <div className="text">
            ...
            <p>
              ...
              that BlogVault evolves with your needs.
            </p>
          </div>
          <div className="image">
            <img
      ...
      <div className="hero-content">
        ...
        <p>
          At BlogVault, we believe that the best digital experiences are built together. By joining our community, you become part of a vibrant network of creators, innovators, and digital enthusiasts who are passionate about shaping the future of the web.
        </p>
